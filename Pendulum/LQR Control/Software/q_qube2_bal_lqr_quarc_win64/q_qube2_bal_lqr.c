 ...
 * C source code generated on : Sun Mar  8 16:07:00 2026
 *
...
void q_qube2_bal_lqr_output(void)
{
  ...
  if (rtmIsMajorTimeStep(q_qube2_bal_lqr_M)) {
    ...
    /* S-Function Block: q_qube2_bal_lqr/Rotary Pendulum Interface/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_HILReadEncoderTimebase_o1 =
          q_qube2_bal_lqr_DW.HILReadEncoderTimebase_Buffer[0];
        rtb_alpha = q_qube2_bal_lqr_DW.HILReadEncoderTimebase_Buffer[1];
      }
    }
     ...
     */
    rtb_alpha *= q_qube2_bal_lqr_P.Pendulumcountstorad_Gain;
    rtb_alpha = rt_modd_snf(rtb_alpha, q_qube2_bal_lqr_P.Constant1_Value);

    /* Bias: '<S6>/Bias' */
    q_qube2_bal_lqr_B.Bias = rtb_alpha + q_qube2_bal_lqr_P.Bias_Bias;
  ...
  rtb_Gain1 = q_qube2_bal_lqr_P.SignalGenerator_Frequency *
    q_qube2_bal_lqr_M->Timing.t[0];
  if (rtb_Gain1 - floor(rtb_Gain1) >= 0.5) {
    rtb_Gain1 = q_qube2_bal_lqr_P.SignalGenerator_Amplitude;
  } else {
    rtb_Gain1 = -q_qube2_bal_lqr_P.SignalGenerator_Amplitude;
  }
   ...
   *  Gain: '<Root>/Gain'
   */
  rtb_Gain1 = q_qube2_bal_lqr_P.Gain_Gain_e * rtb_Gain1 *
  ...
  /* Gain: '<S4>/Gain' */
  q_qube2_bal_lqr_B.Gain_b[0] = q_qube2_bal_lqr_P.Gain_Gain_a * rtb_Gain1;
  q_qube2_bal_lqr_B.Gain_b[1] = q_qube2_bal_lqr_P.Gain_Gain_a *
    q_qube2_bal_lqr_B.Armcountstorad;
  if (rtmIsMajorTimeStep(q_qube2_bal_lqr_M)) {
    /* Abs: '<Root>/|alpha|' */
    rtb_alpha = fabs(q_qube2_bal_lqr_B.Bias);

    /* RelationalOperator: '<S2>/Compare' incorporates:
     *  Constant: '<S2>/Constant'
     */
    q_qube2_bal_lqr_B.Compare = (uint8_T)(rtb_alpha <=
  ...
  if (q_qube2_bal_lqr_B.Compare == 0) {
    ...
    q_qube2_bal_lqr_B.EnableBalanceControlSwitch =
      (((q_qube2_bal_lqr_P.ConverttoVector_Gain[0] * rtb_Gain1 -
         q_qube2_bal_lqr_B.Armcountstorad) * q_qube2_bal_lqr_P.K[0] +
        (q_qube2_bal_lqr_P.ConverttoVector_Gain[1] * rtb_Gain1 -
         q_qube2_bal_lqr_B.Bias) * q_qube2_bal_lqr_P.K[1]) +
       (q_qube2_bal_lqr_P.ConverttoVector_Gain[2] * rtb_Gain1 -
        (q_qube2_bal_lqr_P.theta_dot_C * q_qube2_bal_lqr_X.theta_dot_CSTATE +
         q_qube2_bal_lqr_P.theta_dot_D * q_qube2_bal_lqr_B.Armcountstorad)) *
       q_qube2_bal_lqr_P.K[2]) + (q_qube2_bal_lqr_P.ConverttoVector_Gain[3] *
      rtb_Gain1 - (q_qube2_bal_lqr_P.alpha_dot_C *
                   q_qube2_bal_lqr_X.alpha_dot_CSTATE +
                   q_qube2_bal_lqr_P.alpha_dot_D * q_qube2_bal_lqr_B.Bias)) *
      q_qube2_bal_lqr_P.K[3];
  }
...
RT_MODEL_q_qube2_bal_lqr_T *q_qube2_bal_lqr(void)
{
  ...
  /* External mode info */
  q_qube2_bal_lqr_M->Sizes.checksums[0] = (1589390033U);
  q_qube2_bal_lqr_M->Sizes.checksums[1] = (2515542863U);
  q_qube2_bal_lqr_M->Sizes.checksums[2] = (3996948677U);
  q_qube2_bal_lqr_M->Sizes.checksums[3] = (186691422U);
  ...
  q_qube2_bal_lqr_M->Sizes.numBlockIO = (7);/* Number of block outputs */
