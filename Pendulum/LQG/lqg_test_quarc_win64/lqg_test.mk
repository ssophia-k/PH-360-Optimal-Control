...
PRODUCT_NAME              = lqg_test
MAKEFILE                  = lqg_test.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2021b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2021b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\SOPHIA~1.KLY\Desktop\OPTIMA~1\Pendulum\LQG
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = lqg_test_comp.rsp
CMD_FILE                  = lqg_test.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\lqg_test.rt-win64
...
DEFINES_STANDARD = -DMODEL=lqg_test -DNUMST=2 -DNCSTATES=6 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
{$(START_DIR)\lqg_test_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\lqg_test_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
lqg_test.obj : $(START_DIR)\lqg_test_quarc_win64\lqg_test.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\lqg_test_quarc_win64\lqg_test.c


lqg_test_data.obj : $(START_DIR)\lqg_test_quarc_win64\lqg_test_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\lqg_test_quarc_win64\lqg_test_data.c


lqg_test_main.obj : $(START_DIR)\lqg_test_quarc_win64\lqg_test_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\lqg_test_quarc_win64\lqg_test_main.c


rtGetInf.obj : $(START_DIR)\lqg_test_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\lqg_test_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\lqg_test_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\lqg_test_quarc_win64\rtGetNaN.c
