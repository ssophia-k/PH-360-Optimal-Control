    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(16)  = dumData; %prealloc
                    ...
                    ;% lqg_test_P.BandLimitedWhiteNoise1_Cov
                    section.data(10).logicalSrcIdx = 9;
                    section.data(10).dtTransOffset = 12;

                    ;% lqg_test_P.BandLimitedWhiteNoise_Cov
                    ...
                    ;% lqg_test_P.kemsJ_gain
                    section.data(13).logicalSrcIdx = 12;
                    section.data(13).dtTransOffset = 19;

                    ;% lqg_test_P.ErmJ_gain
                    section.data(14).logicalSrcIdx = 13;
                    section.data(14).dtTransOffset = 20;

                    ;% lqg_test_P.BandLimitedWhiteNoise1_seed
                    section.data(15).logicalSrcIdx = 14;
                    section.data(15).dtTransOffset = 21;

                    ;% lqg_test_P.BandLimitedWhiteNoise_seed
            ...
            section.data(64)  = dumData; %prealloc
                    ...
                    ;% lqg_test_P.UnitDelay_InitialCondition
                    ...
                    ;% lqg_test_P.utrue0estimate_Threshold
                    ...
                    ;% lqg_test_P.WhiteNoise_StdDev_a
            ...
            section.data(12)  = dumData; %prealloc
                    ...
                    ;% lqg_test_P.ToHostFile1_Decimation
                    section.data(11).logicalSrcIdx = 95;
                    section.data(11).dtTransOffset = 14;

                    ;% lqg_test_P.ToHostFile1_BitRate
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% lqg_test_DW.NextOutput
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 3;

                    ;% lqg_test_DW.NextOutput_o
                    section.data(4).logicalSrcIdx = 3;
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% lqg_test_DW.ToHostFile1_PointsWritten
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% lqg_test_DW.Pendulumdeg1_PWORK.LoggedData
                    section.data(2).logicalSrcIdx = 9;
                    section.data(2).dtTransOffset = 1;

                    ;% lqg_test_DW.PendulumangularvelocityDegs_PWO.LoggedData
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% lqg_test_DW.ToHostFile1_SamplesCount
                    section.data(4).logicalSrcIdx = 25;
                    section.data(4).dtTransOffset = 3;

                    ;% lqg_test_DW.ToHostFile1_ArrayNameLength
                    section.data(5).logicalSrcIdx = 26;
                    section.data(5).dtTransOffset = 4;

                    ;% lqg_test_DW.RandSeed_g
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% lqg_test_DW.Impulse_SubsysRanBC
    ...
    targMap.checksum0 = 3863130946;
    targMap.checksum1 = 3056390902;
    targMap.checksum2 = 1419047151;
    targMap.checksum3 = 3880578026;
