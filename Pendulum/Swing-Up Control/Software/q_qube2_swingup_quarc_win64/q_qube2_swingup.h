...
typedef struct {
  real_T Pendulumcountstorad;          /* '<S10>/Pendulum:  counts to rad' */
  real_T Bias;                         /* '<S12>/Bias' */
  real_T Gain;                         /* '<S5>/Gain' */
  real_T Gain_a;                       /* '<S6>/Gain' */
  real_T PendTorqueNm;                 /* '<S14>/Pend Torque (N.m)' */
  real_T JtomJ;                        /* '<S8>/J to mJ' */
  real_T Armcountstorad;               /* '<S10>/Arm: counts to rad' */
  real_T Gain_i;                       /* '<S4>/Gain' */
  real_T SliderGain;                   /* '<S9>/Slider Gain' */
  real_T mJtoJ;                        /* '<S8>/mJ to J' */
  real_T cosalpha;                     /* '<S13>/cos(alpha)' */
  real_T UnaryMinus;                   /* '<S13>/Unary Minus' */
  real_T u0V;                          /* '<Root>/+//-10V' */
...
typedef struct {
  real_T alpha_dot_CSTATE;             /* '<S11>/alpha_dot' */
  real_T theta_dot_CSTATE;             /* '<S11>/theta_dot' */
} X_q_qube2_swingup_T;
...
/* State disabled  */
typedef struct {
  boolean_T alpha_dot_CSTATE;          /* '<S11>/alpha_dot' */
  boolean_T theta_dot_CSTATE;          /* '<S11>/theta_dot' */
...
struct P_q_qube2_swingup_T_ {
  ...
  real_T Step1_YFinal;                 /* Expression: -1
                                        * Referenced by: '<S3>/Step1'
                                        */
  real_T u_max_Value;                  /* Expression: 6
 ...
 * '<S1>'   : 'q_qube2_swingup/Enable Balance Control'
 * '<S2>'   : 'q_qube2_swingup/Er (mJ)'
 * '<S3>'   : 'q_qube2_swingup/Impulse'
 * '<S4>'   : 'q_qube2_swingup/Radians to Degrees'
 * '<S5>'   : 'q_qube2_swingup/Radians to Degrees1'
 * '<S6>'   : 'q_qube2_swingup/Radians to Degrees2'
 * '<S7>'   : 'q_qube2_swingup/Rotary Pendulum Interface'
 * '<S8>'   : 'q_qube2_swingup/Swing-Up Control'
 * '<S9>'   : 'q_qube2_swingup/ke (m//s//J)'
 * '<S10>'  : 'q_qube2_swingup/Rotary Pendulum Interface/Counts to Angles'
 * '<S11>'  : 'q_qube2_swingup/Rotary Pendulum Interface/State X'
 * '<S12>'  : 'q_qube2_swingup/Rotary Pendulum Interface/State X/Full Angle to Inverted'
 * '<S13>'  : 'q_qube2_swingup/Swing-Up Control/Energy-Based Swing-Up Control'
 * '<S14>'  : 'q_qube2_swingup/Swing-Up Control/Energy-Based Swing-Up Control/Pendulum Energy'
 * '<S15>'  : 'q_qube2_swingup/Swing-Up Control/Energy-Based Swing-Up Control/User Specified Acceleration Limit'
 */
